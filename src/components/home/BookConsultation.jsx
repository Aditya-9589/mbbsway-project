                                    ...
                                    <div className="book-form">
                                        ...
                                        <div className="form-row">
                                            <div className="form-col">
                                                <input className="form-input" type="text" required placeholder="Name *" />
                                            </div>

                                            <div className="form-col">
                                                <input className="form-input" type="email" required placeholder="Email *" />
                                            </div>
                                        </div>
                                        ...
                                        {/* Row 3: Message + Button in one row */}
                                        <div className="form-row message-button-row">

                                            {/* Message box (normal height and width like others) */}
                                            <div className="form-col message-col">
